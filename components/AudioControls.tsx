...
interface AudioControlsProps {
  ...
  onSettingChange: (key: keyof AudioSettings, value: number | boolean) => void;
...
export const AudioControls: React.FC<AudioControlsProps> = ({
  ...
  const generalTooltipText =
    "Activates after player interaction (e.g., click play) due to browser rules.";
  const volumeTooltipText =
    "Volume above 100% activates after player interaction (e.g., click play) due to browser rules.";
    ...
    },
    {
      ...
      icon: (
        <svg
          ...
          fill="none"
        >
          <path d="M19 9V15" /> <path d="M15 5V19" /> <path d="M11 9V15" />{" "}
          <path d="M7 6V18" /> <path d="M3 10V14" />
        </svg>
      ),
    },
  ];
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center">
              ...
              >
                ...
                {key === "volume" && settings.volume > 100 && (
                  <InfoTooltip text={volumeTooltipText} />
                )}
                {/* Use general tooltip text for other boosts */}
                {(key === "bassBoost" || key === "voiceBoost") && (

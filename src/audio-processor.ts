...
export class AudioProcessor {
  ...
  private async updateNodeSettings(
    ...
    try {
      ...
      // debugLog("AudioProcessor: Settings updated successfully", { // Reduced logging
  ...
  async tryResumeContext(): Promise<void> {
    if (this.audioContext && this.audioContext.state === "suspended") {
      ...
      // debugLog(`AudioProcessor: AudioContext state is already "${this.audioContext.state}", no resume needed.`); // Reduced logging
    }
  }
